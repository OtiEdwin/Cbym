...
function Section_1() {
    return(
        <section className='ratio-9 col'>
            ...
            <div className='alt-5'>
                <p>
                    Yes!<br/> Since you are here, Then you either know what the purpose of this platform is, or you are looking to find out what we are all about.<br/>
                    If your being here implies already knowing the purpose of this platform, Then very much like me, You are a supporter of <span className='primary-dark pee'>Sir Asiwaju Bola Ahmed Tinubu</span>, A great man and a philantropist.<br/>
                    Also, it may be the case that you are somewhat unsure of your choice for the next leader of our great nation. If so, Then this is also the place for you. A place where you can get unfiltered information on our coming president 2023.<hr/>
